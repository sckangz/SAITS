...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, inputs, stage):
        ...
        # print('reconstruction_loss'+str(reconstruction_MAE)+'imputation_loss'+str(imputation_MAE))
...
class SAITS(nn.Module):
    ...
    def forward(self, inputs, stage):
        ...
        reconstruction_loss += masked_mae_cal(X_tilde_1, X, masks)   # X_tilde: 即X~；   X：原序列
